...
<body>
    <div class="relative flex flex-col w-full min-h-screen max-w-[390px] mx-auto bg-[#F8F8F9]">
        ...
        <div id="Top-Nav-Fixed" class="flex items-center justify-between w-full max-w-[390px] px-4 mt-[60px] z-20">
        ...
        <div class="relative mt-5 flex flex-1 justify-center items-center p-4 w-full h-full">
            <div class="flex flex-col h-fit w-full max-w-[361px] rounded-[30px] p-5 gap-6 bg-white">
                ...
                <h1 class="font-bold text-2xl leading-9 text-center">Your Booking Finished, <br>Well Done! 🤩</h1>
                <div>
                    <div
                        ...
                        <img src="{{asset('assets/images/icons/receipt-text.svg')}}" class="w-8 h-8 flex shrink-0"
                            alt="icon">
                        <p>Booking ID <span
                                class="font-bold text-[#07B704]">{{$bookingTransaction->booking_trx_id}}</span>
                        </p>
                    </div>
                    <p class="text-red-600 text-[10px]">* please remember your booking id or you can screenshot
                        your
                        booking
                        id
                    </p>
                </div>
                <p class="leading-[28px] text-center">We will check the payment and update the status to your whatsapp
                    number</p>
